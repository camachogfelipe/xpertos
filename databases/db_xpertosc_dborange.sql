...
MySQL - 5.5.42-37.1-log : Database - xpertosc_dborange
*********************************************************************
*/
...
/*Database structure for database `xpertosc_dborange` */

CREATE DATABASE /*!32312 IF NOT EXISTS*/`xpertosc_dborange` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `xpertosc_dborange`;
...
/*!50106 CREATE DEFINER=`xpertosc_uorange`@`localhost` EVENT `leave_taken_status_change` ON SCHEDULE EVERY 1 HOUR STARTS '2015-09-16 22:31:47' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
